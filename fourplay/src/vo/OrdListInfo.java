...
public class OrdListInfo {
	private String ol_id, ol_buyer, ol_ismember, ol_bname, ol_bphone, ol_bmail, ol_rname, ol_rphone, ol_rzip, ol_raddr1, ol_raddr2, 
	ol_comment, ol_payment, ol_status, ol_date;
	// ol_buyer: 회원ID or 세션ID
	...
	public String getOl_ismember() {
		return ol_ismember;
	}
	public void setOl_ismember(String ol_ismember) {
		this.ol_ismember = ol_ismember;
	}
