...
<td width="*" valign="top">
	...
	<tr><td colspan="2" align="center"><%=pdtInfo.getPl_name() %></td></tr>
<%
	...
	if (pdtInfo.getPl_discount() > 0){ // 할인율이 있으면
		...
		price = "<s color='red'>" + price + "</s><tr><td>옵션적용</td><td>" + dcprice + "</td></tr>";
		point = dcprice / 100;
	}
%>
...
<% } %>
	...
	<tr><td colspan="2" align="center">
		<input type="button" value="BUY NOW" onclick="goDirect();" <%=dis%> />
	</td></tr>
	<tr><td colspan="2" align="center">
		<input type="button" value="ADD TO CART" onclick="goCart();" <%=dis%> />
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
		<input type="button" value="WISH LIST" onclick="goWish();" <%=dis%> />
	</td></tr>
	</form>
	</table>
</td>
