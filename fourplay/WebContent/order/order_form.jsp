...
#ordList #ordTitle li { width:10%; float:left; padding:10px; text-align:center;}
#ordList #ordTitle li:first-child { width:20%; margin-left:230px; margin-right:60px;}

#ordList .ordContent  {width:100%; height:80px;}
...
#ordList .ordContent .pdtImg {margin:10px;}


.total {display:block; height:30px; text-align:right; font-weight:bold; }
...
%>
		<span class="total">총 <%=total %> 원</span>
</div>
<h3>01 주문하시는 분</h3>
<div id="bInfo">
<table>
