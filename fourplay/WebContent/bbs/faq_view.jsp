...
<td width="12%" align="right"><%=article.getFq_date().substring(2, 10).replace('-', '.') %>&nbsp;&nbsp;&nbsp;</td>
</tr>
<tr>
<td colspan="6">
...
<tr height="30"></tr>
<tr>
<td align="right" colspan="6"><input class="button" type="button" value="목록으로" onclick="location.href='bbs_list.faq<%=args %>';" /></td>
</tr>
</table>
</div>
</body>
