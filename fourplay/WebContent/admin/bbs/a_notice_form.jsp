...
<style>
.bnform { font-size:13px; }
.nfcon td { border-bottom:1px #8C8C8C solid; }
.nfcon input { border:1px #8C8C8C solid;}
...
<table class="bnform" width="700" cellpadding="5" cellspacing="0">
...
<tr class="button"><td colspan="4" align="right">
	<input type="button" value="목록으로" onclick="location.href='bbs_list.anotice<%=args %>';" />
	&nbsp;&nbsp;&nbsp;
